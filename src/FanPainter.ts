...
export default class FanPainter {
  ...
  selectRad(
    ...
    this._fanBuffer.appendData(this.aTexCoord, generateRectangleTexcoords());
  ...
  setAscendingRadius(ascendingRadius: number) {
    this._ascendingRadius = ascendingRadius;
  }

  setDescendingRadius(descendingRadius: number) {
...
const fanPainterTests = new TestSuite("FanPainter");
